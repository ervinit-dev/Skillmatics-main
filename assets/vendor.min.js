...
/* cart api */
var addToCartHandler = window.addToCartHandler ={
  ...
  addItem: function(line_item) {
    ...
    if($(window).width() <= 767){
      ...
      $("body .tt-cart.tt-dropdown-obj").addClass("active");  
    }
